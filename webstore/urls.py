...
urlpatterns = [
    ...
    path('products_by_name', views.products_by_name, name='products_by_name_url'),
    path('products_by_category/cat/<int:pk>/', views.products_by_category, name='products_by_category_url'),
    path('products_in_cat_by_name/cat/<int:pk>/', views.products_in_cat_by_name, name='products_in_cat_by_name_url'),
